    ...
    <div class="modal-content">
      <div class="modal-header" :style="{
        ...
        <div class="header-content">
          ...
          <div>
            <h3>Add New Field</h3>
            <p class="field-type-badge">{{ getFieldTypeLabel(newField.type) }}</p>
          </div>
        </div>
      ...
      <div class="modal-body-split" :style="{
          ...
          <div class="editor-scroll">
            ...
            <div class="editor-section">
              <div class="section-title">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24" :style="{ color: themeColors.primary }">
              ...
              <div class="field-type-grid">
                <button
                  ...
                  :class="{ active: newField.type === fieldType.value }"
                  class="type-card"
                  :style="newField.type === fieldType.value ? {
                    background: themeColors.primary,
                    borderColor: themeColors.primary,
                    color: theme === 'dark' ? themeColors.text : '#ffffff'
                  } : {}"
                >
                  <div class="type-icon" v-html="fieldType.icon" :style="newField.type === fieldType.value ? { color: theme === 'dark' ? themeColors.text : '#ffffff' } : { color: themeColors.primary }"></div>
            ...
            <div class="editor-section">
              ...
              <div class="form-group-modern" v-if="!['label', 'heading'].includes(newField.type)">
            ...
            <!-- Input Type Section -->
            <div class="editor-section" v-if="newField.type === 'input'">
              <div class="section-title">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                </svg>
              ...
              <div class="input-type-grid">
                <button
                  ...
                  :key="inputType.value"
                  @click="newField.input_type = inputType.value"
                  :class="{ active: newField.input_type === inputType.value }"
                  class="type-card"
                  :style="newField.input_type === inputType.value ? {
                    background: themeColors.primary,
                    borderColor: themeColors.primary,
                    color: theme === 'dark' ? themeColors.text : '#ffffff'
                  } : {}"
                >
                  <div class="type-icon" v-html="inputType.icon" :style="newField.input_type === inputType.value ? { color: theme === 'dark' ? themeColors.text : '#ffffff' } : { color: themeColors.primary }"></div>
              ...
              <div class="form-group-modern">
                ...
                <input
                  ...
                  type="text"
                  class="modern-input"
                  :placeholder="`e.g., ${getPlaceholderExample(newField.input_type)}`"
                />
              </div>
            </div>

            <!-- Options Section -->
            <div class="editor-section" v-if="['select', 'radio'].includes(newField.type)">
              <div class="section-title">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Textarea Section -->
            <div class="editor-section" v-if="newField.type === 'textarea'">
              <div class="section-title">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="form-group-modern">
                ...
                <div class="slider-group">
                  <input
                    ...
                    class="modern-slider"
                  />
                  <span class="slider-value">{{ newField.rows }}</span>
                </div>
              </div>
            ...
            <!-- Heading Section -->
            <div class="editor-section" v-if="newField.type === 'heading'">
              <div class="form-group-modern">
                <label class="modern-label">Heading Level</label>
                <select
                  v-model.number="newField.level"
                  class="modern-input"
                >
            ...
            <!-- Settings Section -->
            <div class="editor-section" v-if="!['label', 'heading'].includes(newField.type)">
              <div class="section-title">
                <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <label class="modern-toggle" :style="newField.required ? { borderColor: themeColors.primary } : {}">
                <input
                  v-model="newField.required"
                  type="checkbox"
                  class="toggle-input"
                />
                <span class="toggle-slider" :style="newField.required ? { background: themeColors.primary } : {}"></span>
            ...
            <div class="editor-section">
              ...
              <div class="alignment-buttons">
                <button
                  ...
                  :class="{ active: newField.formatting?.alignment === 'left' }"
                  class="align-button"
                  title="Left Align"
                  :style="newField.formatting?.alignment === 'left' ? {
                    background: themeColors.primary,
                    borderColor: themeColors.primary,
                    color: theme === 'dark' ? themeColors.text : '#ffffff'
                  } : {}"
                ...
                <button
                  ...
                  :class="{ active: newField.formatting?.alignment === 'center' }"
                  class="align-button"
                  title="Center Align"
                  :style="newField.formatting?.alignment === 'center' ? {
                    background: themeColors.primary,
                    borderColor: themeColors.primary,
                    color: theme === 'dark' ? themeColors.text : '#ffffff'
                  } : {}"
                >
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 20 20">
                    <path fill-rule="evenodd" d="M3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3 4a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm-3 4a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zm3 4a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1z" clip-rule="evenodd" />
                  </svg>
                </button>
                <button
                  @click="setAlignment('right')"
                  :class="{ active: newField.formatting?.alignment === 'right' }"
                  class="align-button"
                  title="Right Align"
                  :style="newField.formatting?.alignment === 'right' ? {
                    background: themeColors.primary,
                    borderColor: themeColors.primary,
                    color: theme === 'dark' ? themeColors.text : '#ffffff'
                  } : {}"
        ...
        <div class="preview-panel">
          <div class="preview-header">
            <svg width="18" height="18" fill="none" stroke="currentColor" viewBox="0 0 24 24" :style="{ color: themeColors.primary }">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
          ...
          <div class="preview-content">
            <div class="preview-field" :style="{ textAlign: newField.formatting?.alignment || 'left' }">
              <component
            ...
            <div class="preview-info">
              <div class="info-item">
                ...
                <span class="info-value">{{ getFieldTypeLabel(newField.type) }}</span>
              </div>
              <div class="info-item" v-if="newField.field_name">
                <span class="info-label">ID:</span>
                <span class="info-value info-code">{{ newField.field_name }}</span>
              </div>
              <div class="info-item" v-if="newField.required">
      ...
      <div class="modal-footer">
        ...
        <button @click="addField" class="btn btn-primary" :disabled="!isValid" :style="{
          background: isValid ? themeColors.primary : '#9ca3af',
          color: theme === 'dark' ? themeColors.text : '#ffffff'
        }">
          Add Field
        </button>
...
const optionsText = ref('Option 1\nOption 2\nOption 3')
...
const changeFieldType = (type) => {
  newField.value.type = type
  if (type === 'input' && !newField.value.input_type) {
    newField.value.input_type = 'text'
  }
  if (type === 'heading' && !newField.value.level) {
    newField.value.level = 2
  }
  if (type === 'textarea' && !newField.value.rows) {
    newField.value.rows = 4
  }
}

const setAlignment = (alignment) => {
  if (!newField.value.formatting) {
    newField.value.formatting = {}
  }
  newField.value.formatting.alignment = alignment
}
...
const getPreviewComponent = () => {
  ...
  return components[newField.value.type] || LabelField
}

const getPreviewProps = () => {
  const baseProps = {
    ...newField.value,
    label: newField.value.label || 'Field Label',
    placeholder: newField.value.placeholder || 'Placeholder...',
    modelValue: '',
    theme: props.theme
  }
...
const addField = () => {
  ...
  if (['select', 'radio'].includes(field.type)) {
    field.options = optionsText.value
      .split('\n')
      .map(opt => opt.trim())
      .filter(opt => opt.length > 0)
  }
